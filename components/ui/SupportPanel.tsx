  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-emerald-500 text-slate-950 shadow-emerald-500/30 transition-all duration-150 hover:brightness-110 active:scale-[0.95] cursor-pointer "
      ...
      {open && (
        <div className="fixed inset-0 z-[80]">
          ...
          />
          <aside className="animate-slide-in-right absolute right-0 top-0 flex h-full w-full max-w-md flex-col border-slate-800 bg-slate-950 shadow-2xl ">
            <div className="flex items-center justify-between border-slate-800 px-5 py-4 ">
              <div className="flex items-center gap-2">
                <LifeBuoy className="h-4.5 w-4.5 text-emerald-400 " />
            ...
            <div className="flex-1 space-y-5 overflow-y-auto p-5">
              ...
              <div className="rounded-xl border-slate-800 bg-slate-900 p-4 ">
                ...
                <a
                  ...
                  className="text-xs font-medium text-emerald-400 underline-offset-2 transition-all duration-150 hover:underline "
                >
